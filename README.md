...
- Karafka `2.0` Ruby on Rails based [application example](https://github.com/karafka/example-apps/v2.0-rails)
- Karafka `2.0` non Rails based [application example](https://github.com/karafka/example-apps/v2.0-non-rails)
- Karafka `1.4` non Rails based [application example](https://github.com/karafka/example-apps/v1.4-non-rails)
